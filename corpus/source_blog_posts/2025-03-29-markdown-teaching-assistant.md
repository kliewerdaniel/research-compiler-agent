...
description: In this guide, we will build an interactive learning platform that leverages
  AI to generate dynamic lessons, quizzes, and coding challenges from user-uploaded
  Markdown files.
layout: post
tags:
...
wiki_references: ["docker", "embeddings", "knowledge-graphs", "llama3", "local-inference", "ollama", "python", "rag", "sentence-transformers", "typescript"]
---
