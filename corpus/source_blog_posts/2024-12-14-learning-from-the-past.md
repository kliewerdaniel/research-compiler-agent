...
description: Build a React web application that integrates TensorFlow.js for toxicity
  detection, visualizing potentially harmful language through graph structures to
  encourage more positive and ethical digital communication.
layout: post
tags:
- React
- TensorFlow.js
...
title: 'Developing a Toxicity Detection Communication App: Promoting Positive Dialogue
  with AI Ethics, React, and TensorFlow.js'
wiki_references: []
---
